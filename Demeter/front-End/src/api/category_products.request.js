...
export const disableCategory_productsRequest = (ID_CATEGORIA_PRODUCTO) => axios.put(`/category_products/disable/${ID_CATEGORIA_PRODUCTO}`);
export const updateCategory_productsRequest = (ID_CATEGORIA_PRODUCTO, categoryProducts) => axios.put(`/category_products/update/${ID_CATEGORIA_PRODUCTO}`, categoryProducts)
